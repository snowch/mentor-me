...
NutritionEstimate _$NutritionEstimateFromJson(Map<String, dynamic> json) =>
    NutritionEstimate(
      ...
      unsaturatedFatGrams: (json['unsaturatedFatGrams'] as num?)?.toDouble(),
      monoFatGrams: (json['monoFatGrams'] as num?)?.toDouble(),
      polyFatGrams: (json['polyFatGrams'] as num?)?.toDouble(),
